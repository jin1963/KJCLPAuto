...
// ABI พื้นฐานของ ERC20 Token
// ใช้สำหรับ LP Token และ KJC Token
const erc20ABI = [
  {
    "constant": true,
    "inputs": [],
...
// ที่อยู่ contract และ token ของคุณ
const contractAddress = "0xFf77E7b8f574f31BeBF43F3348122a8331da0d47"; // Staking Contract
const lpTokenAddress = "0xdF0d76046E72C183142c5208Ea0247450475A0DF"; // LP Token
...
async function connectWallet() {
  if (window.ethereum) {
    ...
    try {
      ...
      // หากคุณมีโค้ดในไฟล์ staking.js อยู่แล้ว ฟังก์ชันนี้จะเรียกใช้งานได้
      // loadBalances();
      // loadStakeStatus();
